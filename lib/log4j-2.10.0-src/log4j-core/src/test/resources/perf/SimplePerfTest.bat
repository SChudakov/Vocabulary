...
set LOG4J_OPTIONS=%LOG4J_OPTIONS% -DLog4jContextSelector=org.apache.com.sschudakov.logging.log4j.core.async.AsyncLoggerContextSelector
...
set CP=%CP%;C:\Users\remko\IdeaProjects\com.sschudakov.logging-log4j2\log4j-core\target\test-classes
:set CP=%CP%;log4j-core-2.6-SNAPSHOT-tests.jar

set MAIN=org.apache.com.sschudakov.logging.log4j.core.async.perftest.SimplePerfTest
