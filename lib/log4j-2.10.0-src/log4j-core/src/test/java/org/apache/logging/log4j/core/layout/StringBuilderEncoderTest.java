...
public class StringBuilderEncoderTest {
    ...
    public void testEncode_ALotWithoutErrors() throws Exception {
        ...
        final StringBuilder text = new StringBuilder("2016-04-13 21:07:47,487 DEBUG [org.apache.com.sschudakov.logging.log4j.perf.jmh.FileAppenderBenchmark.log4j2ParameterizedString-jmh-worker-1] FileAppenderBenchmark  - This is a debug [2383178] message\r\n");
