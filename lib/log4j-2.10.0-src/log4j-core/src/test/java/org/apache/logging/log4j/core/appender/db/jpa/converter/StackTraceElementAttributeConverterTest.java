...
public class StackTraceElementAttributeConverterTest {
    ...
    public void testConvert02() {
        final StackTraceElement element = new StackTraceElement("org.apache.com.sschudakov.logging.TestWithPackage",
        ...
        assertEquals("The converted value is not correct.",
                "org.apache.com.sschudakov.logging.TestWithPackage.testConvert02(TestWithPackage.java)",
                converted);

        final StackTraceElement reversed = this.converter.convertToEntityAttribute(converted);

        assertNotNull("The reversed value should not be null.", reversed);
        assertEquals("The class name is not correct.", "org.apache.com.sschudakov.logging.TestWithPackage", reversed.getClassName());
    ...
    public void testConvert03() {
        final StackTraceElement element = new StackTraceElement("org.apache.com.sschudakov.logging.TestNoSource",
        ...
        assertNotNull("The converted value should not be null.", converted);
        assertEquals("The converted value is not correct.",
                "org.apache.com.sschudakov.logging.TestNoSource.testConvert03(Unknown Source)",
                converted);

        final StackTraceElement reversed = this.converter.convertToEntityAttribute(converted);

        assertNotNull("The reversed value should not be null.", reversed);
        assertEquals("The class name is not correct.", "org.apache.com.sschudakov.logging.TestNoSource", reversed.getClassName());
    ...
    public void testConvert04() {
        final StackTraceElement element = new StackTraceElement("org.apache.com.sschudakov.logging.TestIsNativeMethod",
        ...
        assertNotNull("The converted value should not be null.", converted);
        assertEquals("The converted value is not correct.",
                "org.apache.com.sschudakov.logging.TestIsNativeMethod.testConvert04(Native Method)",
                converted);

        final StackTraceElement reversed = this.converter.convertToEntityAttribute(converted);

        assertNotNull("The reversed value should not be null.", reversed);
        assertEquals("The class name is not correct.", "org.apache.com.sschudakov.logging.TestIsNativeMethod",
