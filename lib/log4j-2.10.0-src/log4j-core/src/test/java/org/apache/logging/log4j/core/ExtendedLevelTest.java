...
public class ExtendedLevelTest {
    ...
    public void testLevelLogging() {
        org.apache.logging.log4j.Logger logger = context.getLogger("org.apache.com.sschudakov.logging.log4j.test1");
        ...
        logger = context.getLogger("org.apache.com.sschudakov.logging.log4j.test2");
