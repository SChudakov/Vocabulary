...
public class InputWordsJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        wordsWordValueJTF = new HintTextField();
        ...
        wordsCollectionNameJTF = new HintTextField();
        wordsWordClassJCB = new javax.swing.JComboBox<>();
        wordsMeaningJTF = new HintTextField();
        wordsDeleteMeaningJB = new javax.swing.JButton();
        wordFoundIndidcator = new LedIndicator();
        ...
        collectionsCollectionNameJTF = new HintTextField();
        ...
        mainJTP.addChangeListener(this::mainJTPStateChanged);

        wordsTabJPanel.setPreferredSize(new java.awt.Dimension(600, 500));

        wordsLanguageJCB.addItemListener(this::wordsLanguageJCBItemStateChanged);

        meaningsJLabel.setText("Meanings");

        wordCollectionsJL.setText("Collections");

        wordsMeaningsLanguageJCB.addItemListener(this::wordsMeaningsLanguageJCBItemStateChanged);

        jScrollPane1.setViewportView(wordsMeaningsJL);

        wordsSaveWordJB.setText("Save word");
        wordsSaveWordJB.addActionListener(this::wordsSaveWordJBActionPerformed);
        ...
        collectionDeleteCollectionJB.addActionListener(evt -> collectionDeleteCollectionJBActionPerformed(evt));
    ...
    private void setFoundStatus(boolean found) {
        ...
        if (found) {
            wordFoundIndidcator.setColor(LedIndicator.LedColor.GREEN);
        } else {
            wordFoundIndidcator.setColor(LedIndicator.LedColor.RED);
        }
    ...
    private HintTextField collectionsCollectionNameJTF;
    ...
    private LedIndicator wordFoundIndidcator;
    private javax.swing.JButton wordsAddMeaningJB;
    private HintTextField wordsCollectionNameJTF;
    ...
    private HintTextField wordsMeaningJTF;
    ...
    private HintTextField wordsWordValueJTF;
